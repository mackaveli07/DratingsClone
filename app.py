        ...
        <div class="team-block">
            ...
            <div>
                ...
                <div>
                    ...
                    Live Spread: <strong>{-float(live_spread_away if live_spread_away != 'N/A' else 0)}</strong>
                </div>
                <div class="prob-bar">
                    <div class="prob-fill away-color" style="width: {max(prob_away*100,1):.1f}%;"></div>
                </div>
    ...
    with cols[1]:
        ...
        <div class="team-block" style="justify-content:flex-end;">
            <div style="text-align:right;">
                ...
                <div>
                    Model Spread: <strong>{predicted_spread:+.1f}</strong> |
                    Live Spread: <strong>{float(live_spread_home if live_spread_home != 'N/A' else 0)}</strong>
                </div>
                <div class="prob-bar">
                    <div class="prob-fill home-color" style="width: {max(prob_home*100,1):.1f}%;"></div>
                </div>
...
st.markdown("""<div style="background: linear-gradient(90deg, #2563eb, #3b82f6); padding: 16px; border-radius: 16px; margin-bottom: 24px; color: white; font-weight: 800; font-size: 2.2rem; text-align: center; box-shadow: 0 8px 32px rgb(59 130 246 / 0.4);">Live Predictions & Value Bets</div>""", unsafe_allow_html=True)
...
st.markdown('<div class="footer">Powered by TheOddsAPI + Elo Model | Updated Live</div>', unsafe_allow_html=True)
